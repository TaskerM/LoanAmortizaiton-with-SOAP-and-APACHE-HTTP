...
public class LoanCalcServiceMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver {
        ...
        try {
            ...
            if ((op.getName() != null) &&
                ...
                if ("verifyEmailPIN".equals(methodName)) {
                    org.amortizer.loancalcservice.VerifyEmailPINResponse verifyEmailPINResponse55 =
                        null;
                    ...
                    verifyEmailPINResponse55 = skel.verifyEmailPIN(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            verifyEmailPINResponse55, false,
                            new javax.xml.namespace.QName(
                                "http://www.amortizer.org/LoanCalcService/",
                                "VerifyEmailPINResponse"));
                } else
                 if ("deleteEmailPIN".equals(methodName)) {
                    org.amortizer.loancalcservice.DeleteEmailPINResponse deleteEmailPINResponse57 =
                        null;
                    ...
                    deleteEmailPINResponse57 = skel.deleteEmailPIN(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            deleteEmailPINResponse57, false,
                            new javax.xml.namespace.QName(
                                "http://www.amortizer.org/LoanCalcService/",
                                "DeleteEmailPINResponse"));
                } else
                 if ("calcLoanTerm".equals(methodName)) {
                    org.amortizer.loancalcservice.CalcLoanTermResponse calcLoanTermResponse59 =
                        null;
                    ...
                    calcLoanTermResponse59 = skel.calcLoanTerm(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            calcLoanTermResponse59, false,
                            new javax.xml.namespace.QName(
                                "http://www.amortizer.org/LoanCalcService/",
                                "CalcLoanTermResponse"));
                } else
                 if ("calcLoanRate".equals(methodName)) {
                    org.amortizer.loancalcservice.CalcLoanRateResponse calcLoanRateResponse61 =
                        null;
                    ...
                    calcLoanRateResponse61 = skel.calcLoanRate(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            calcLoanRateResponse61, false,
                            new javax.xml.namespace.QName(
                                "http://www.amortizer.org/LoanCalcService/",
                                "CalcLoanRateResponse"));
                } else
                 if ("checkEmail".equals(methodName)) {
                    org.amortizer.loancalcservice.CheckEmailResponse checkEmailResponse63 =
                        null;
                    ...
                    checkEmailResponse63 = skel.checkEmail(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            checkEmailResponse63, false,
                            new javax.xml.namespace.QName(
                                "http://www.amortizer.org/LoanCalcService/",
                                "CheckEmailResponse"));
                } else
                 if ("calcLoanPmt".equals(methodName)) {
                    org.amortizer.loancalcservice.CalcLoanPmtResponse calcLoanPmtResponse65 =
                        null;
                    ...
                    calcLoanPmtResponse65 = skel.calcLoanPmt(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            calcLoanPmtResponse65, false,
                            new javax.xml.namespace.QName(
                                "http://www.amortizer.org/LoanCalcService/",
                                "CalcLoanPmtResponse"));
                } else
                 if ("calcLoanAmt".equals(methodName)) {
                    org.amortizer.loancalcservice.CalcLoanAmtResponse calcLoanAmtResponse67 =
                        null;
                    ...
                    calcLoanAmtResponse67 = skel.calcLoanAmt(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            calcLoanAmtResponse67, false,
                            new javax.xml.namespace.QName(
                                "http://www.amortizer.org/LoanCalcService/",
                                "CalcLoanAmtResponse"));
                } else
                 if ("calcLoanPayoff".equals(methodName)) {
                    org.amortizer.loancalcservice.CalcLoanPayoffResponse calcLoanPayoffResponse69 =
                        null;
                    org.amortizer.loancalcservice.CalcLoanPayoff wrappedParam = (org.amortizer.loancalcservice.CalcLoanPayoff) fromOM(msgContext.getEnvelope()
                                                                                                                                                .getBody()
                                                                                                                                                .getFirstElement(),
                            org.amortizer.loancalcservice.CalcLoanPayoff.class);

                    calcLoanPayoffResponse69 = skel.calcLoanPayoff(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            calcLoanPayoffResponse69, false,
                            new javax.xml.namespace.QName(
                                "http://www.amortizer.org/LoanCalcService/",
                                "CalcLoanPayoffResponse"));
                } else
                 if ("showAmortTable".equals(methodName)) {
                    org.amortizer.loancalcservice.ShowAmortTableResponse showAmortTableResponse71 =
                        null;
                    org.amortizer.loancalcservice.ShowAmortTable wrappedParam = (org.amortizer.loancalcservice.ShowAmortTable) fromOM(msgContext.getEnvelope()
                                                                                                                                                .getBody()
                                                                                                                                                .getFirstElement(),
                            org.amortizer.loancalcservice.ShowAmortTable.class);

                    showAmortTableResponse71 = skel.showAmortTable(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            showAmortTableResponse71, false,
                            new javax.xml.namespace.QName(
                                "http://www.amortizer.org/LoanCalcService/",
                                "ShowAmortTableResponse"));
                } else {
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    org.amortizer.loancalcservice.CalcLoanPayoffResponse.MY_QNAME,
                    factory));
    ...
    private org.amortizer.loancalcservice.CalcLoanPayoffResponse wrapCalcLoanPayoff() {
        org.amortizer.loancalcservice.CalcLoanPayoffResponse wrappedElement = new org.amortizer.loancalcservice.CalcLoanPayoffResponse();
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    org.amortizer.loancalcservice.ShowAmortTableResponse.MY_QNAME,
                    factory));
    ...
    private org.amortizer.loancalcservice.ShowAmortTableResponse wrapShowAmortTable() {
        org.amortizer.loancalcservice.ShowAmortTableResponse wrappedElement = new org.amortizer.loancalcservice.ShowAmortTableResponse();
