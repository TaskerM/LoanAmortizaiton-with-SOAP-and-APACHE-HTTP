		...
		if (object instanceof JButton) {
			...
			if (((JButton) object).getText().trim().equalsIgnoreCase("Ok")) {
				...
				try {
					...
					if (msg != null
							&& msg.equalsIgnoreCase("Check the email address you entered for a verification pin number.")) {
						JOptionPane.showMessageDialog(this,
								String.format("Your PIN has been emailed to: %s", this.emailAddress.getText()));
					...
					JOptionPane.showMessageDialog(this, "2-Step Email Verification Unavailable.");
				}
				...
				try {
					...
					if (msg != null && msg.equalsIgnoreCase("success")) {
						JOptionPane.showMessageDialog(this,
								String.format("Your PIN has been verified.", this.emailAddress.getText()));
