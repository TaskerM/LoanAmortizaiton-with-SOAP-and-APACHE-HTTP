...
import org.amortizer.loancalcservice.LoanCalcServiceStub.CalcLoanAmtResponse;
import org.amortizer.loancalcservice.LoanCalcServiceStub.CalcLoanPmt;
import org.amortizer.loancalcservice.LoanCalcServiceStub.CalcLoanPmtResponse;
import org.amortizer.loancalcservice.LoanCalcServiceStub.CalcLoanRate;
import org.amortizer.loancalcservice.LoanCalcServiceStub.CalcLoanRateResponse;
import org.amortizer.loancalcservice.LoanCalcServiceStub.CalcLoanTerm;
import org.amortizer.loancalcservice.LoanCalcServiceStub.CalcLoanTermResponse;
...
public class LoanCalcServiceHandler {
	...
	public double calcLoanAmt(LoanCalcModel lcModel) {
		...
		CalcLoanAmtResponse clAmtRes = null;
		try {
	...
	public double calcLoanPmt(LoanCalcModel lcModel) {
		...
		CalcLoanPmtResponse clPmtRes = null;
		try {
	...
	public double calcLoanRate(LoanCalcModel lcModel) {
		...
		CalcLoanRateResponse clRateRes = null;
		try {
	...
	public int calcLoanTerm(LoanCalcModel lcModel) {
		...
		CalcLoanTermResponse clTermRes = null;
		try {
